...
var allowedTransitions = map[workflowTransition]bool{
	...
	transition(PhaseSpec, StatusFailed, PhaseSpec, StatusRunning):                      true,
	...
	transition(PhaseImplementation, StatusFailed, PhaseImplementation, StatusRunning):  true,
	...
	transition(PhaseReview, StatusFailed, PhaseReview, StatusRunning):                  true,
